...
import com.technorahulkumar.accounts.dto.AccountsDto;
...
import com.technorahulkumar.accounts.exception.CustomerAlreadyExistsException;
import com.technorahulkumar.accounts.exception.ResourceNotFoundException;
import com.technorahulkumar.accounts.mapper.AccountsMapper;
    ...
    public boolean updateAccount(CustomerDto customerDto) {
        ...
        if(accountsDto != null){
            Accounts accounts = accountsRepository.findById(accountsDto.getAccountNumber()).orElseThrow(
                () -> new ResourceNotFoundException("Accont", "accountNumber", accountsDto.getAccountNumber().toString())
            );
